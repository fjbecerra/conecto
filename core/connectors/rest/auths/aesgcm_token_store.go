...
func (s *AESGCMTokenStore) Get(runtime core.Runtime) (Token, error) {

	record, err := s.Store.GetToken(runtime)
...
func (s *AESGCMTokenStore) Save(runtime core.Runtime, token Token) error {
	...
	return s.Store.SaveToken(runtime,record)
}
